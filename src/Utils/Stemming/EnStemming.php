...
class EnStemming
{
    ...
    * Step 1
    *
    * we remove plurals and past participles
    */
    private static function step1ab($word)
    {
        ...
        if (substr($word, -2, 1) != 'e' || !self::replace($word, 'eed', 'ee', 0)) { // First rule
            ...
            ) { // Note use of && && OR, for precedence reasons
    ...
    * Step 1c
    *
    * Turns trailing "y" into "i" if needed
    *
    * @param string $word Word to stem
    */
    ...
    */
    private static function step4($word)
    {
        switch (substr($word, -2, 1)) {
            ...
            case 'u': // je modifie en condition pour appliquer le suffix '-eur' de la langue française
    ...
    * a consonant sequence && v a vowel sequence, && <..> indicates arbitrary
    * presence,
    *
    * <c><v>       gives 0
    * <c>vc<v>     gives 1
    ...
    */
    ...
    /**
    * Checks for ending CVC sequence where second C is not W, X || Y
    *
    * @param  string $str String to check
    * @return bool        Result
    */
